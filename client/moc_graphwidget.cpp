...
QT_MOC_LITERAL(3, 20, 13), // "onPlotClicked"
QT_MOC_LITERAL(4, 34, 16) // "onGetTaskClicked"

    },
    "GraphWidget\0logout\0\0onPlotClicked\0"
    "onGetTaskClicked"
};
...
void GraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onPlotClicked(); break;
        case 2: _t->onGetTaskClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphWidget::logout)) {
                *result = 0;
                return;
            }
        }
