...
QT_MOC_LITERAL(3, 31, 8), // "showAuth"
QT_MOC_LITERAL(4, 40, 17) // "onRegisterClicked"

    },
    "RegWidget\0registrationSuccess\0\0showAuth\0"
    "onRegisterClicked"
};
...
void RegWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RegWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegWidget::registrationSuccess)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RegWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegWidget::showAuth)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegWidget::registrationSuccess()
{
